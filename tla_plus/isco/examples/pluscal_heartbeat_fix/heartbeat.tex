...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} heartbeat}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TLC ,\, Integers ,\, FiniteSets}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmalgorithm} heartbeat}%
 \@x{ {\p@variables} alive \.{=}\@s{4.1} 1 \.{\dotdot} 3 ,\, replOwner \.{=} [
 x \.{\in} 1 \.{\dotdot} 3 \.{\mapsto} x ] ,\, replStuck \.{=} [ x \.{\in} 1
 \.{\dotdot} 3 \.{\mapsto} {\FALSE} ] ,\, killed \.{=} \{ \} {\p@semicolon}}%
\@x{ {\p@fair} {\p@process} node \.{\in} 1 \.{\dotdot} 3}%
\@x{ {\p@begin} P\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@while} self \.{\in} alive {\p@do}}%
\@x{\@s{32.8} CheckIfStuck\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{49.19} {\p@if} \{ x \.{\in} 1 \.{\dotdot} 3 \.{:} replOwner [ x ]
 \.{=} self \.{\land} replStuck [ x ] \} \.{\neq} \{ \} {\p@then}}%
 \@x{\@s{64.74} killed \.{:=} killed \.{\cup} \{ x \.{\in} 1 \.{\dotdot} 3
 \.{:} replStuck [ x ] \.{\land} replOwner [ x ] \.{=} self \}
 {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{32.8} RestartReplicator\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{49.19} {\p@if} \{ x \.{\in} 1 \.{\dotdot} 3 \.{:} replOwner [ x ]
 \.{=} self \.{\land} replStuck [ x ] \} \.{\neq} \{ \} {\p@then}}%
 \@x{\@s{64.74} replStuck \.{:=} [ x \.{\in} 1 \.{\dotdot} 3 \.{\mapsto}
 {\CASE} replOwner [ x ] \.{=} self \.{\rightarrow} {\FALSE} {\Box} {\OTHER}
 \.{\rightarrow} replStuck [ x ] ] {\p@semicolon}}%
 \@x{\@s{64.74} killed \.{:=} killed \.{\,\backslash\,} \{ x \.{\in} 1
 \.{\dotdot} 3 \.{:} replOwner [ x ] \.{=} self \} {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{16.4} {\p@end} {\p@while} {\p@semicolon}}%
\@x{\@s{16.4} NodeDown\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@await} self \.{\in} alive {\p@semicolon}}%
\@x{\@s{16.4} {\p@goto} P {\p@semicolon}}%
\@x{ {\p@end} {\p@process}}%
\@pvspace{8.0pt}%
\@x{ {\p@fair} \.{+} {\p@process} orchestrator \.{=} 0}%
\@x{ {\p@begin} Orchestrator\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@while} alive \.{\neq} \{ \} {\p@do}}%
\@x{\@s{32.8} {\p@either}}%
\@x{\@s{49.19} RebootNode\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{65.6} {\p@if} Cardinality ( alive ) \.{>} 1 {\p@then}}%
\@x{\@s{80.24} {\p@with} x \.{\in} alive {\p@do}}%
\@x{\@s{96.64} alive \.{:=} alive \.{\,\backslash\,} \{ x \} {\p@semicolon}}%
\@x{\@s{96.64} replOwner \.{:=} [ z \.{\in} 1 \.{\dotdot} 3 \.{\mapsto}}%
 \@x{\@s{113.04} {\CASE} replOwner [ z ] \.{=} x \.{\rightarrow} {\CHOOSE} y
 \.{\in} alive \.{:} x \.{\neq} y}%
\@x{\@s{113.04} {\Box} {\OTHER} \.{\rightarrow} replOwner [ z ]}%
\@x{\@s{96.64} ] {\p@semicolon}}%
\@x{\@s{80.24} {\p@end} {\p@with} {\p@semicolon}}%
\@x{\@s{65.6} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{32.8} {\p@or}}%
\@x{\@s{49.19} MakeReplicatorStuck\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{65.6} {\p@with} x \.{\in} 1 \.{\dotdot} 3 {\p@do}}%
\@x{\@s{82.0} replStuck [ x ] \.{:=} {\TRUE} {\p@semicolon}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{23f8c013}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{d5065706}'')
}%
\@xx{}%
\@x{ {\VARIABLES} alive ,\, replOwner ,\, replStuck ,\, killed ,\, pc}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} alive ,\, replOwner ,\, replStuck ,\, killed
 ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( 1 \.{\dotdot} 3 ) \.{\cup} \{ 0 \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} alive \.{=} 1 \.{\dotdot} 3}%
 \@x{\@s{35.70} \.{\land} replOwner \.{=} [ x \.{\in} 1 \.{\dotdot} 3
 \.{\mapsto} x ]}%
 \@x{\@s{35.70} \.{\land} replStuck\@s{5.23} \.{=} [ x \.{\in} 1 \.{\dotdot} 3
 \.{\mapsto} {\FALSE} ]}%
\@x{\@s{35.70} \.{\land} killed \.{=} \{ \}}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto} {\CASE}
 self \.{\in} 1 \.{\dotdot} 3 \.{\rightarrow}\@w{P}}%
 \@x{\@s{160.39} {\Box}\@s{10.30} self \.{=} 0
 \.{\rightarrow}\@w{Orchestrator} ]}%
\@pvspace{8.0pt}%
\@x{ P ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P}}%
\@x{\@s{50.90} \.{\land} {\IF} self \.{\in} alive}%
 \@x{\@s{74.17} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{CheckIfStuck} ]}%
 \@x{\@s{74.17} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{NodeDown} ]}%
 \@x{\@s{50.90} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner ,\,
 replStuck ,\, killed {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ CheckIfStuck ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{CheckIfStuck}}%
 \@x{\@s{100.16} \.{\land} {\IF} \{ x \.{\in} 1 \.{\dotdot} 3 \.{:} replOwner
 [ x ] \.{=} self \.{\land} replStuck [ x ] \} \.{\neq} \{ \}}%
 \@x{\@s{123.42} \.{\THEN} \.{\land} killed \.{'} \.{=} ( killed \.{\cup} \{ x
 \.{\in} 1 \.{\dotdot} 3 \.{:} replStuck [ x ] \.{\land} replOwner [ x ]
 \.{=} self \} )}%
\@x{\@s{123.42} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{154.73} \.{\land} {\UNCHANGED} killed}%
 \@x{\@s{100.16} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{RestartReplicator} ]}%
 \@x{\@s{100.16} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner ,\,
 replStuck {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ RestartReplicator ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{RestartReplicator}}%
 \@x{\@s{119.58} \.{\land} {\IF} \{ x \.{\in} 1 \.{\dotdot} 3 \.{:} replOwner
 [ x ] \.{=} self \.{\land} replStuck [ x ] \} \.{\neq} \{ \}}%
 \@x{\@s{142.85} \.{\THEN} \.{\land} replStuck \.{'} \.{=} [ x \.{\in} 1
 \.{\dotdot} 3 \.{\mapsto} {\CASE} replOwner [ x ] \.{=} self \.{\rightarrow}
 {\FALSE} {\Box} {\OTHER} \.{\rightarrow} replStuck [ x ] ]}%
 \@x{\@s{174.16} \.{\land} killed \.{'} \.{=} killed \.{\,\backslash\,} \{ x
 \.{\in} 1 \.{\dotdot} 3 \.{:} replOwner [ x ] \.{=} self \}}%
\@x{\@s{142.85} \.{\ELSE} \.{\land} {\TRUE}}%
 \@x{\@s{174.16} \.{\land} {\UNCHANGED} {\langle} replStuck ,\, killed
 {\rangle}}%
 \@x{\@s{119.58} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P} ]}%
 \@x{\@s{119.58} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NodeDown ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{NodeDown}}%
\@x{\@s{90.53} \.{\land} self \.{\in} alive}%
 \@x{\@s{90.53} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P} ]}%
 \@x{\@s{90.53} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner ,\,
 replStuck ,\, killed {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ node ( self ) \.{\defeq} P ( self ) \.{\lor} CheckIfStuck ( self )
 \.{\lor} RestartReplicator ( self )}%
\@x{\@s{79.57} \.{\lor}\@s{1.21} NodeDown ( self )}%
\@pvspace{8.0pt}%
\@x{ Orchestrator \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{Orchestrator}}%
\@x{\@s{74.52} \.{\land} {\IF} alive \.{\neq} \{ \}}%
 \@x{\@s{97.79} \.{\THEN} \.{\land} \.{\lor} \.{\land} pc \.{'} \.{=} [ pc
 {\EXCEPT} {\bang} [ 0 ] \.{=}\@w{RebootNode} ]}%
 \@x{\@s{140.21} \.{\lor} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0
 ] \.{=}\@w{MakeReplicatorStuck} ]}%
 \@x{\@s{97.79} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0
 ] \.{=}\@w{Done} ]}%
 \@x{\@s{74.52} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner ,\,
 replStuck ,\, killed {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RebootNode \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{RebootNode}}%
\@x{\@s{69.88} \.{\land} {\IF} Cardinality ( alive ) \.{>} 1}%
\@x{\@s{93.15} \.{\THEN} \.{\land} \E\, x \.{\in} alive \.{:}}%
\@x{\@s{143.77} \.{\land} alive \.{'} \.{=} alive \.{\,\backslash\,} \{ x \}}%
 \@x{\@s{143.77} \.{\land} replOwner \.{'} \.{=}\@s{53.3} [ z \.{\in} 1
 \.{\dotdot} 3 \.{\mapsto}}%
 \@x{\@s{228.09} {\CASE} replOwner [ z ] \.{=} x \.{\rightarrow} {\CHOOSE} y
 \.{\in} alive \.{'} \.{:} x \.{\neq} y}%
\@x{\@s{228.09} {\Box} {\OTHER} \.{\rightarrow} replOwner [ z ]}%
\@x{\@s{211.69} ]}%
\@x{\@s{93.15} \.{\ELSE} \.{\land} {\TRUE}}%
 \@x{\@s{124.46} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner
 {\rangle}}%
 \@x{\@s{69.88} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{Orchestrator} ]}%
 \@x{\@s{69.88} \.{\land} {\UNCHANGED} {\langle} replStuck ,\, killed
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ MakeReplicatorStuck \.{\defeq} \.{\land} pc [ 0 ]
 \.{=}\@w{MakeReplicatorStuck}}%
\@x{\@s{110.71} \.{\land} \E\, x \.{\in} 1 \.{\dotdot} 3 \.{:}}%
 \@x{\@s{130.03} replStuck \.{'} \.{=} [ replStuck {\EXCEPT} {\bang} [ x ]
 \.{=} {\TRUE} ]}%
 \@x{\@s{110.71} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{Orchestrator} ]}%
 \@x{\@s{110.71} \.{\land} {\UNCHANGED} {\langle} alive ,\, replOwner ,\,
 killed {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ orchestrator \.{\defeq} Orchestrator \.{\lor} RebootNode \.{\lor}
 MakeReplicatorStuck}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} orchestrator}%
 \@x{\@s{52.13} \.{\lor} ( \E\, self \.{\in} 1 \.{\dotdot} 3 \.{:} node ( self
 ) )}%
\@x{\@s{52.13} \.{\lor} Terminating}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} 1 \.{\dotdot} 3 \.{:} {\WF}_{
 vars} ( node ( self ) )}%
\@x{\@s{39.83} \.{\land} {\SF}_{ vars} ( orchestrator )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ MyProperty \.{\defeq} \A\, x \.{\in} 1 \.{\dotdot} 3 \.{:} ( {\Diamond}
 ( replStuck [ x ] \.{\leadsto} {\lnot} replStuck [ x ] \.{\lor} alive \.{=}
 \{ x \} \.{\lor} x \.{\in} killed ) )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
